...
namespace GGXrdWakeupDPUtil
{
    ...
    public partial class Window1
    {
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            _reversalTool.RandomBurstLoopErrorOccured += ReversalToolRandomBurstLoopErrorOccured;
        ...
        private void ReversalToolRandomBurstLoopErrorOccured(Exception ex)
        {
            StopBurst();
        }
            ...
            try
            {
                ...
                switch (Math.Sign(latestVersion.Version.CompareTo(currentVersion)))
                {
                    case 0:
                        ...
                        break;
                    case -1:
                        if (!confirm || MessageBox.Show($"A new version is available ({latestVersion.Version})\r\bDo you want do download it?", "New version available", MessageBoxButton.YesNo) == MessageBoxResult.Yes)
                        {
